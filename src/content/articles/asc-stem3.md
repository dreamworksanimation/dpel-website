...
imageCaption: {
  ...
  text: [
    "COMING SUMMER 2026 -- The American Society of Cinematographers Motion Imaging Technology Council introduces the next phase of the ASC Standard Evaluation Material projects: ASC MITC StEM3-VP, the third StEM project specifically for in-camera visual effects virtual production LED wall/volume technology.",
